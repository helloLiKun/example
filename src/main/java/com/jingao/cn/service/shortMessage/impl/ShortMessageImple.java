...
public class ShortMessageImple implements ShortMessageService {
    ...
    public void sendShorMessage() throws IOException {
        ...
        NameValuePair[] data ={ new NameValuePair("Uid", "lk13923813589"),new NameValuePair("Key", "a2cb2e0c055fa19143db"),new NameValuePair("smsMob","15099884020"),new NameValuePair("smsText","通知：你大yeye喊你吃饭【天鸿科技】")};
