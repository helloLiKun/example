...
public class MailServiceImpl implements MailService {
    ...
    public static String myEmailAccount = "13923813589@163.com";
    public static String myEmailPassword = "lk123456";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1281509283@qq.com";
    ...
    public void createMail() {
        ...
        //    真正要发送时, 邮箱必须是真实有效的邮箱。
        try {
            message.setFrom(new InternetAddress("13923813589@163.com", "USER_AA", "UTF-8"));

            // 3. To: 收件人
            message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress("1281509283@qq.com", "USER_CC", "UTF-8"));
            //    To: 增加收件人（可选）
